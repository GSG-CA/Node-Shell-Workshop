...
If you want to see a detailed break-down on this at any point there are notes on this example stored [here.](https://github.com/GSG-CA/Node-Shell-Workshop/blob/master/fs-readFile.md) It's not necessary to go into that much depth to do these exercises, the syntax you need is provided, just in case it provides any clarity.
